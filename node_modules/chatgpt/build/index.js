...
var ChatGPTAPI = class {
  ...
  async _buildPrompt(message, opts) {
    ...
    const promptPrefix = opts.promptPrefix || `You are ${ASSISTANT_LABEL}, a large language model trained by OpenAI. You answer as concisely as possible for each response (e.g. don\u2019t be verbose). It is very important that you answer as concisely as possible, so please remember this. If you are generating a list, do not have too many items. Keep the number of items short.
...
${message}<|im_end|>`;
    ...
    do {
      ...
      const parentMessageRoleDesc = parentMessageRole === "user" ? USER_LABEL : ASSISTANT_LABEL;
...
`;
    ...
    const maxTokens = Math.max(1, Math.min(4097 - numTokens, 1e3));
